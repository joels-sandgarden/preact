...
| Page | Covers |
| --- | --- |
| [`core.md`](./core.md) | The root `preact` package and its primary API. |
| [`hooks.md`](./hooks.md) | The `preact/hooks` entry point. |
| [`compat.md`](./compat.md) | The `preact/compat` package. |
| [`compat/client.md`](./compat/client.md) | The `preact/compat/client` entry point. |
| [`compat/server.md`](./compat/server.md) | The `preact/compat/server` entry point. |
| [`compat/scheduler.md`](./compat/scheduler.md) | The `preact/compat/scheduler` entry point. |
