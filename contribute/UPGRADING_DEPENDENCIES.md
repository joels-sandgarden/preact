...
### Webpack version specifiers

Some packages specify webpack as a caret range (for example, `^5.105.0`) rather than an exact version. In that case, `yarn.lock` records the resolved webpack version (for example, `5.105.0`).
