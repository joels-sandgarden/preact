...
* Improved keyed list reordering with lower diffing overhead while preserving the bounded longest increasing subsequence optimization.
...
* Hardened VNode cloning for frozen or restricted JavaScript environments by preserving the VNode constructor in each clone.
