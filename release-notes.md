...
* Reduced the compressed core bundle size by streamlining runtime expressions and compacting internal property names across compatibility, hooks, and JSX runtime modules.
* Improved keyed list reordering for more efficient updates.
* Restored the expected property mapping in Preact ISO builds.
...
* Preserved the `constructor` field when cloning rendered structures in restricted JavaScript environments.
