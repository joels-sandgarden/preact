...
This release candidate delivers smaller compressed bundles, more efficient updates for reordered content, more reliable reconciliation of server-rendered content, and improved compatibility across supported environments.
...
* Updated `package.json`, `package-lock.json`, and the DevTools attachment to identify version `11.0.0-rc.0`.
