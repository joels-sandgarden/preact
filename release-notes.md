...
Preact v11.0.0-rc.0 reduces minified build sizes, lowers overhead when keyed lists change order, and improves rendering correctness and compatibility across core and related packages.
...
* Streamlined list reordering to lower rendering overhead.

## Correctness and Compatibility

* Improved rendering when existing markup is reused by handling unexpected markers, applying element references consistently, and protecting runtime checks.
